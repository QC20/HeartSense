...
// Create HRVTrendVisualizer instance
HRVTrendVisualizer hrvVisualizer(NEOPIXEL_PIN, NUMPIXELS);
...
void setup() {
  ...
  // Initialize HRV Trend Visualizer
  hrvVisualizer.begin();

  Serial.println("HRV Trend Visualizer initialized");
}
...
void loop() {
  ...
  if (currentMillis - lastUpdateTime >= UPDATE_INTERVAL) {
    ...
    if (rrIndex == HRV_WINDOW_SIZE - 1) {
      ...
      // Update the HRV Trend Visualizer
